            ...
            {isShowingHandles && (
                <>
                    ...
                    <rect
                        ...
                        onPointerDown={(e) => {
                            e.stopPropagation();
                            onResizeHandlePointerDown(((Side.Top as number) | (Side.Left as number)) as Side, bounds as XYWH);
                        }}
                    />
                    {/* Top handle */}
                    <rect
                    ...
                    <rect
                        ...
                        onPointerDown={(e) => {
                            e.stopPropagation();
                            onResizeHandlePointerDown(((Side.Top as number) | (Side.Right as number)) as Side, bounds as XYWH);
                        }}
                    />
                    {/* Left handle */}
                    <rect
                    ...
                    <rect
                        ...
                        onPointerDown={(e) => {
                            e.stopPropagation();
                            onResizeHandlePointerDown(((Side.Bottom as number) | (Side.Left as number)) as Side, bounds as XYWH);
                        }}
                    />
                    {/* Bottom handle */}
                    <rect
                    ...
                    <rect
                        ...
                        onPointerDown={(e) => {
                            e.stopPropagation();
                            onResizeHandlePointerDown(((Side.Bottom as number) | (Side.Right as number)) as Side, bounds as XYWH);
                        }}
                    />
                </>
            )}
